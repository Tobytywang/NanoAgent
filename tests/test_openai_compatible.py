...
class TestOpenAICompatibleLLM:
    ...
    def test_init_with_env_var(self, monkeypatch):
        ...
        llm = OpenAICompatibleLLM(model="gpt-4o", api_key_env="TEST_API_KEY")
    ...
    def test_init_api_key_priority_over_env(self, monkeypatch):
        ...
        llm = OpenAICompatibleLLM(
            model="gpt-4o", api_key="direct-key", api_key_env="TEST_API_KEY"
        )
    ...
    def test_init_missing_api_key(self):
        ...
        with pytest.raises(ValueError, match="API key not found"):
            OpenAICompatibleLLM(model="gpt-4o", api_key_env="NONEXISTENT_KEY")
    ...
    def test_chat_with_tools_parameter(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "choices": [{"message": {"content": "Let me check that."}}],
